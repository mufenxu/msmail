...
router.post('/accounts/:id/reauthorize/device', accountController.startReauthorization)
router.post('/accounts/:id/reauthorize/device/:flowId/poll', accountController.pollReauthorization)
router.post('/accounts/:id/reauthorize/device/:flowId/cancel', accountController.cancelReauthorization)
router.get('/accounts/:id/password', accountController.password)
